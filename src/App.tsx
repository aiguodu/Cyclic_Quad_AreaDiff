...
import { tutorialSteps as steps } from './data/tutorialSteps';
...
export default function App() {
  ...
  const [showQuestion, setShowQuestion] = useState(false);         // title hover preview
              ...
              <AnimatePresence>
                {showQuestion && (
                  <motion.div
                    ...
                    className="absolute z-50 top-full left-0 mt-2 p-2 bg-white rounded-xl shadow-2xl border border-slate-200 w-[400px]"
                  >
                    <div className="text-xs text-slate-400 mb-1 px-1">题目原题预览</div>
                    <img src="/images/4-2.png" alt="题目原题" className="w-full h-auto rounded-lg border border-slate-100" />
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="bg-slate-100 p-5 rounded-xl border border-slate-200">
                  ...
                  <div className="text-slate-600 leading-loose text-sm">
